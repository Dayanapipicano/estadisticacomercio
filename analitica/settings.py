...
SECRET_KEY = 'django-insecure-9+%g4dk0x&@^d(gac*gf2p5o-oxbz87as5b$ru&k&wdg@x5f&l'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.personas.context_processors.user_permissions_processor',
            ],
        },
    },
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER =  'pipicanodayana2005@gmail.com'
